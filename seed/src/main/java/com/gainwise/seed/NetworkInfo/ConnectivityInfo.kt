package com.gainwise.seed.NetworkInfo
...
object ConnectivityInfo {
    ...
    fun isDataConnected(context: Context): Boolean {
        val info = ConnectivityInfo.getNetworkInfo(context)
     ...
     * @return
     */
    fun isDataConnectedWifi(context: Context): Boolean {
        val info = ConnectivityInfo.getNetworkInfo(context)
     ...
     * @return
     */
    fun isDataConnectedMobile(context: Context): Boolean {
        val info = ConnectivityInfo.getNetworkInfo(context)
     ...
     * @return
     */
    fun isDataConnectedFast(context: Context): Boolean {
        val info = ConnectivityInfo.getNetworkInfo(context)
        return info != null && info.isConnected && ConnectivityInfo.isConnectionFast(info.type, info.subtype)
    }
    ...
    fun isTelephonyMobileConnected(context: Context): Boolean {
